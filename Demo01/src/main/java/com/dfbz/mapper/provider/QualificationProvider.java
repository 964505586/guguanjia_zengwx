...
public class QualificationProvider {
    ...
    public String selectByCondition(Map<String, Object> params) {
        ...
        sb.append("select qu.*, uu.name uploadUser, su.name checkUser from qualification qu LEFT JOIN sys_user uu on" +
                " qu.upload_user_id = uu.id LEFT JOIN sys_user su on qu.check_user_id = su.id where qu.del_flag = 0");
